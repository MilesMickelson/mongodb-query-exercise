// MongoDB movies collection insert queries

db.movies.insert({ "title": "Star Wars", "writer":"George Lucas", "year": 1977, "actors": [ "Mark Hamill", "Harrison Ford", "Carrie Fisher", "Peter Cushing", "James Earl Jones" ] })
...
db.movies.insert({ "title": "The Hobbit: The Battle of the Five Armies", "writer":"J.R.R. Tolkein", "year": 2012, "franchise":"The Hobbit", "synopsis":"Bilbo and Company are forced to engage in a war against an army of combatants and keep the Lonely Mountain from falling into the hands of a rising darkness." })
db.movies.insert({ "title": "Pee Wee Herman's Big Adventure", "writer":"Phil Hartman", "year": 1985 })
db.movies.insert({ "title": "Avatar" })

// MongoDB find queries for movies collection
...
// MongoDB update queries for movies collection 
...
// MongoDB text search queries for movies collection
...
// MongoDB delete queries for movies collection

db.movies.remove({ "title": "Pee Wee Herman's Big Adventure" })
db.movies.remove({ "title": "Avatar" })

// MongoDB insert queries for users collection
...
// MongoDB insert queries for posts collection
...
//MongoDB insert queries for comments collection
